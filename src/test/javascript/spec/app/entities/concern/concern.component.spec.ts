...
import { ConcernComponent } from 'app/entities/concern/concern.component';
import { ConcernService } from 'app/entities/concern/concern.service';
import { Concern } from 'app/shared/model/concern.model';

describe('Component Tests', () => {
  describe('Concern Management Component', () => {
    let comp: ConcernComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ConcernComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.concerns && comp.concerns[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

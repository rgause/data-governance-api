...
import { DBSourceComponent } from 'app/entities/db-source/db-source.component';
...
describe('Component Tests', () => {
  describe('DBSource Management Component', () => {
    let comp: DBSourceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DBSourceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dBSources && comp.dBSources[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

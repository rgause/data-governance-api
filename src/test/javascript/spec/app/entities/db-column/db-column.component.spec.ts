...
import { DBColumnComponent } from 'app/entities/db-column/db-column.component';
...
describe('Component Tests', () => {
  describe('DBColumn Management Component', () => {
    let comp: DBColumnComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DBColumnComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dBColumns && comp.dBColumns[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

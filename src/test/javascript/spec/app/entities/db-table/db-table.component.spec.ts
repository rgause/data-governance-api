...
import { DBTableComponent } from 'app/entities/db-table/db-table.component';
import { DBTableService } from 'app/entities/db-table/db-table.service';
import { DBTable } from 'app/shared/model/db-table.model';

describe('Component Tests', () => {
  describe('DBTable Management Component', () => {
    let comp: DBTableComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DBTableComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dBTables && comp.dBTables[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
